...
Hooks:Add( "MenuManagerInitialize", "MenuManagerInitialize_SoloHeisterHelper", function( menu_manager )
	...
	MenuCallbackHandler.callback_intim_amount = function(self, item)
		SoloHeisterHelper.options.intim_amount = tonumber(item:value())
		SoloHeisterHelper:Save()
	end
	
	MenuCallbackHandler.callback_cable_amount = function(self, item)
		SoloHeisterHelper.options.cable_amount = tonumber(item:value())
		SoloHeisterHelper:Save()
	end
